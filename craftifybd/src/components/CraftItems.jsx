        ...
        <div className="card bg-base-100 shadow-lg transition hover:scale-105 hover:shadow-lg">
          ...
          <div className="card-body items-start">
            ...
            <div className="card-actions w-full">
              <button className="w-full px-6 py-2 font-medium bg-indigo-500 text-white rounded-lg transition-all shadow-[3px_3px_0px_black] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px]">
                View Details
              </button>
            </div>
          </div>
